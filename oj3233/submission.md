...
```text
check your ticket with winning ticket and output your winnings
input: winning ticket, your ticket
output: prize money
important constrain: correctly check tickets
```
...
Step 2: check tickets using if-else conditions
Step 3: print out your prize
```
...
```text
it is the same because first plan already correctly check tickets and output correct prize
```
