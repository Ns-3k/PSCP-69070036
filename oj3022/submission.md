...
```text
conver tempeture from one unit to another
input: temperature, initial unit, unit converted to
output: converted temperature
important constrain: correctly isolate variable in the equation for calculation
```
...
Step 3: convert celsius to final temperature
```
...
```text
it is the same
because equation is correct, every testcases passed
```
...
```text
celsius to rankine with decimals
```
